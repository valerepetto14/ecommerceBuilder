...
const ShopifyIntegrationPage = () => {
  return (
    <div className="p-10 h-[700px] rounded-md mx-auto w-full flex flex-col gap-4 bg-white shadow-md">
      ...
      <Input
        ...
        classNames={{
          label: "text-default-400 text-xs font-normal text-gray-600 font-bold",
